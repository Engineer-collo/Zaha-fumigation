...
export default function App() {
  ...
  const services = [
    ...
    },
    {
      ...
      need:
        'Cleaning dining seats improves hygiene and maintains a clean dining experience for families and guests.',
      remedy:
        'Our team performs stain removal, deep sanitization, and fabric-safe cleaning for all dining chairs.',
    },
    {
    ...
    },
    {
      ...
      need:
        'Professional mattress cleaning helps create a healthy and comfortable sleeping environment.',
      remedy:
        'We use deep extraction and sanitizing techniques to eliminate dirt, bacteria, and allergens from mattresses.',
    },
  ]

  const otherServices = [
    'Car Seats & Interior Detailing',
    'Office Cleaning',
    'Deep House Cleaning',
    'Move-In / Move-Out Cleaning',
    'Post-Construction Cleaning',
    'Post-Renovation Cleaning',
    'Outdoor Cleaning (Cabro, Mazeras)',
    'Housekeeping Services',
    'Wardrobe Organizing & Decluttering',
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gray-100 rounded-3xl p-8 shadow-lg">
              <h3 className="text-3xl font-black text-blue-700 mb-6">
                Additional Services
              </h3>
              ...
              <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
                {otherServices.map((service, index) => (
                  <div
                    key={index}
                    className="bg-white rounded-2xl p-4 shadow-md font-semibold hover:-translate-y-1 transition"
                  >
                    {service}
                  </div>
                ))}
