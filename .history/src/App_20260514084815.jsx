...
>
  Contact
      ...
      <section
        id="home"
        className="pt-6 min-h-screen bg-gradient-to-r from-green-700 to-green-900 text-white flex items-center"
      >
  ...
  <div className="max-w-7xl mx-auto px-6">
    <div className="text-center mb-16">
      ...
      <p className="text-gray-600 text-lg">
        Trusted by homeowners, offices, apartments, and businesses.
      </p>
    </div>
    ...
    <div className="grid md:grid-cols-3 gap-8">
      {testimonials.map((testimonial, index) => (
        <div
          key={index}
          className="bg-white rounded-3xl shadow-lg p-8 hover:-translate-y-2 transition duration-300 border border-gray-100"
        >
          <div className="flex items-center gap-4 mb-6">
            <img
              src={testimonial.image}
              alt={testimonial.name}
              className="w-20 h-20 rounded-full object-cover object-top border-4 border-green-100"            />
  ...
  <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12">
    ...
    <div>
      ...
      <div>
        ...
        <div className="rounded-3xl overflow-hidden shadow-2xl border border-green-700">
          <iframe
            title="Zaha Fumigation Location"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15955.08918753688!2d36.817223!3d-1.286389!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x182f10d7b5b4f2d5%3A0x7e3b0c3d3e0d4f7a!2sNairobi!5e0!3m2!1sen!2ske!4v1710000000000!5m2!1sen!2ske"
            width="100%"
            height="320"
            style={{ border: 0 }}
            allowFullScreen=""
